...
const Order = () => {
  const { currency, price } = useContext(ShopContext);
  return (
          ...
          >
            <div className="flex items-start gap-6 text-sm">
              ...
              <div>
                ...
                <p className="mt-2">
                  Date: <span className="text-gray-400"> 26 , sept , 2024</span>
                </p>
              </div>
            </div>
            <div className="md:w-1/2 flex justify-between">
              ...
              <button className="border px-4 py-3 text-sm font-medium rounded-sm">
                Track Order
              </button>
            </div>
          </div>
